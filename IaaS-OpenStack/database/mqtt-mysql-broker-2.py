...
broker = "172.24.4.102"       # MQTT broker ip address or name
broker_port = 1883         # MQTT broker port

sub_prefix = "#"       # Own subscribe topic
pub_prefix = "db"        # General publish topic

db_hostname = "localhost"  # MySQL host ip address or name
db_database = "mqtt"       # MySQL database name
db_username = "root"   # MySQL database user name
